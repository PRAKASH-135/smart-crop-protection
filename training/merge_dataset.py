...
SOURCE_IMAGES = "training/public_dataset_raw/images/val"
SOURCE_LABELS = "training/public_dataset_raw/labels/val"
...
for img_name in image_files:
    ...
    if img_name in val_files:
        shutil.copy2(src_img, os.path.join(DEST_IMAGES_VAL, img_name))
        shutil.copy2(src_label, os.path.join(DEST_LABELS_VAL, label_name))
        copied_val += 1
    else:
        shutil.copy2(src_img, os.path.join(DEST_IMAGES_TRAIN, img_name))
        shutil.copy2(src_label, os.path.join(DEST_LABELS_TRAIN, label_name))
        copied_train += 1
